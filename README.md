...
معماری اعتماد صفر (ZTA) یک پارادایم امنیتی است که تمرکز خود را از دفاع در لبه شبکه (فایروال‌های سنتی) به حفاظت مستقیم از منابع (کاربران، دارایی‌ها و داده‌ها) منتقل می‌کند.
